...
double cur_enc_L= 0, cur_enc_R= 0,prev_enc_l=0,err_l = 0,err_r=0,prev_enc_r=0,vel_l =0,vel_r=0,rpm_l,rpm_r,val_l=0.3,val_r=0.3;
void loop() {
...
vel_l = ((cur_enc_L-prev_enc_l)*60*12)/29520;
  vel_r =((cur_enc_R- prev_enc_r)*60*12)/29520;
  err_l = val_l - vel_l;
  err_r = val_r - vel_r;
  //rpm_l = rpm_l + err_l*0.8;
  //rpm_r = rpm_r + err_r*0.8;
