...
# Subject to change
motor_left = serial.Serial("/dev/ttyUSB2", 9600, timeout=0.5)
motor_right = serial.Serial("/dev/ttyUSB3", 9600, timeout=0.5)
...
def main():
    ...
    motor_serial_write(motor_left, "R900")
    #motor_serial_write(motor_right, "R900")
